...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nobis obcaecati qui doloremque sapiente eveniet quia fugit rerum repellat rem ab, porro voluptas maiores dignissimos ratione accusantium laborum harum aspernatur! Ducimus esse sit praesentium, odit illo similique pariatur optio fugit dolores ab provident quo qui voluptatibus quis eum voluptas cupiditate suscipit!
                </p>
    ...
    <div class="movie-class border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 hover:text-gray:300">Sonic HedgeHog</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            <span>
                                <svg class="fill-current text-orange-500 w-4" viewBox="0 0 24 24"><g data-name="Layer 2"><path d="M17.56 21a1 1 0 01-.46-.11L12 18.22l-5.1 2.67a1 1 0 01-1.45-1.06l1-5.63-4.12-4a1 1 0 01-.25-1 1 1 0 01.81-.68l5.7-.83 2.51-5.13a1 1 0 011.8 0l2.54 5.12 5.7.83a1 1 0 01.81.68 1 1 0 01-.25 1l-4.12 4 1 5.63a1 1 0 01-.4 1 1 1 0 01-.62.18z" data-name="star"/></g></svg>
                            </span>
